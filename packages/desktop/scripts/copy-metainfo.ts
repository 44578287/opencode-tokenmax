...
const appId =
  channel === "prod" ? "ai.opencode.desktop" : channel === "dev" ? "ai.opencode.tokenmax.dev" : `ai.opencode.desktop.${channel}`
const productName =
  channel === "prod" ? "OpenCode" : channel === "dev" ? "OpenCode TokenMax Dev" : `OpenCode ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
